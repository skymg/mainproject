...
#
#
#     api_url = "https://192.168.56.102/restconf/data/ietf-interfaces:interfaces/interface?depth=unbounded"
#     headers = {
...
#     # print(response_json)
#     # print(json.dumps(response_json, indent=4))
#     state_information = interface_state_information()
#     return render(request, 'show_all_interface.html', context={"data": data,"state_information":state_information})
#
# #get interface_state_information
# def interface_state_information():
#     api_url = "https://192.168.56.102/restconf/data/ietf-interfaces:interfaces-state/interface?depth=unbounded"
#     headers = {
#         "Accept": "application/yang-data+json",
#         "Content-type": "application/yang-data+json"
#     }
...
def show_all_interface_restconf():
    api_url = "https://192.168.56.102/restconf/data/ietf-interfaces:interfaces/interface?depth=unbounded"
    headers = {
        "Accept": "application/yang-data+json",
        "Content-type": "application/yang-data+json"
    ...
    return data
    # #get interface_state_information
def show_interface_state_information():
    api_url = "https://192.168.56.102/restconf/data/ietf-interfaces:interfaces-state/interface?depth=unbounded"
    headers = {
        "Accept": "application/yang-data+json",
        "Content-type": "application/yang-data+json"
    ...
    resp = requests.get(api_url, auth=basicauth, headers=headers, verify=False)
    response_json = resp.json()
    state_information = json.dumps(response_json, indent=4)
    return state_information

def restconf_interface(request):
    data = show_all_interface_restconf()
    state_data = show_interface_state_information()
    return render(request,'show_all_interface.html',context={"data":data,"state_data":state_data})
